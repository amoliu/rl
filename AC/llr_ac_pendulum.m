function [critic, actor, cr] = llr_ac_pendulum()
    ...
    actor.memory      = 2000;
    actor.llr         = LLR(actor.memory, spec.observation_dims, 1, 20, llr.tikhonov, llr.gamma);
    actor.alpha       = 0.05;
    
    critic.memory     = 2000;
    critic.llr        = LLR(critic.memory, spec.observation_dims, 1, 20, llr.tikhonov, llr.gamma, -1000);
    critic.alpha      = 0.25;
    ...
    random_u          = 0;        % Random noise for action - Global variable declaration
