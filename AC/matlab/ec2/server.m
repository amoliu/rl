        ...
        while 1
            ...
            switch received.command
              ...
              case {codes.dyna}
                ...
                [~, ~, cr] = dyna_pendulum('mode', 'episode', 'episodes', episodes, 'steps', steps, 'alpha', alpha, 'verbose', true);
                mssend(sock,cr);
              case {codes.dyna_mlac}
                ...
                [episodes, steps, alpha] = deal(received.arguments{:});
                [~, ~, cr] = dyna_mlac_pendulum('mode', 'episode', 'episodes', episodes, 'steps', steps, 'alpha', alpha, 'verbose', true);
                mssend(sock,cr);
              case {codes.all}
                if debug
